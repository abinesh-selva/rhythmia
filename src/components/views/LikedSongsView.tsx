...
export function LikedSongsView({ onContextMenu }: LikedSongsViewProps) {
  ...
  return (
    <div className="flex flex-col min-h-full pb-20">
      {/* Header Hero */}
      <div className="hero p-6 md:p-10 flex flex-col md:flex-row md:items-end gap-6 border-b border-cream/5 relative overflow-hidden transition-all" style={{ background: 'linear-gradient(to bottom, rgba(92,50,230,0.6), var(--theme-forest-dark))' }}>
