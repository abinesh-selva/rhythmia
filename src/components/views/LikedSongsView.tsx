...
export function LikedSongsView({ onContextMenu, showToast }: LikedSongsViewProps) {
  ...
  return (
    <div className="flex flex-col min-h-full pb-20">
      {/* Header Hero */}
      <div className="hero bg-gradient-to-b from-[#5C32E6]/60 to-forest-dark p-6 md:p-10 flex flex-col md:flex-row md:items-end gap-6 border-b border-cream/5 relative overflow-hidden transition-all">
        <div className="absolute inset-0 bg-gradient-to-t from-forest-dark/80 to-transparent z-0" />
        
        <div className="hero-art w-40 h-40 md:w-56 md:h-56 rounded-xl bg-gradient-to-br from-[#450AF5] to-[#C4EFD9] flex items-center justify-center flex-none shadow-2xl z-10 transition-transform hover:scale-[1.02]">
      ...
      {/* Tracks list */}
      <div className="px-6 md:px-10 flex flex-col gap-1.5 flex-1 mt-2">
        {likedTracks.length === 0 ? (
